...
public class ButAScratchAchievement extends Achievements {
    ...
    public void onAchievement(Player player) {
        ...
        player.sendMessage(ChatColor.AQUA + player.getName() + ChatColor.DARK_AQUA + " has completed the " + ChatColor.RED + "Tis' But a Scratch" + ChatColor.DARK_AQUA + " achievement!");
