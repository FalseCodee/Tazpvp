...
public class LivingOnEdgeAchievement extends Achievements {
    ...
    public void onAchievement(Player player) {
        ...
        Bukkit.broadcastMessage(ChatColor.AQUA + player.getName() + ChatColor.DARK_AQUA + " has completed the "+ ChatColor.RED + "Living on the edge" + ChatColor.DARK_AQUA + " achievement!");
