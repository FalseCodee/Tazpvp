...
public class SmackAchievement extends Achievements {
    ...
    public void onAchievement(Player player) {
        ...
        Bukkit.broadcastMessage(ChatColor.AQUA + player.getName() + ChatColor.DARK_AQUA + " has completed the " + ChatColor.RED + count + " smacks " + ChatColor.DARK_AQUA + "achievement!");
