...
public class Fisherman {
    ...
    public Fisherman(Player p){
        ...
        if (Objects.equals(inhand, new ItemStack(Material.COAL_ORE, amount))) {
            ...
            p.sendMessage(ChatColor.YELLOW + "[NPC] Miner:" + ChatColor.WHITE + " Here, take " + ChatColor.GOLD + "$" + amount * 1.2);
        } else if (Objects.equals(inhand, new ItemStack(Material.IRON_ORE, amount))) {
            p.getInventory().setItemInHand(new ItemStack(Material.AIR));
            TazPvP.statsManager.addMoney(p, amount);
            p.sendMessage(ChatColor.YELLOW + "[NPC] Miner:" + ChatColor.WHITE + " Thank you for your business!");
            p.sendMessage(ChatColor.YELLOW + "[NPC] Miner:" + ChatColor.WHITE + " Here, take " + ChatColor.GOLD + "$" + amount * 1.5);
            ...
            p.sendMessage(ChatColor.YELLOW + "[NPC] Miner:" + ChatColor.WHITE + " Thank you for your business!");
            p.sendMessage(ChatColor.YELLOW + "[NPC] Miner:" + ChatColor.WHITE + " Here, take " + ChatColor.GOLD + "$" + amount * 2.5);
            ...
            p.sendMessage(ChatColor.YELLOW + "[NPC] Miner:" + ChatColor.WHITE + " Thank you for your business!");
            p.sendMessage(ChatColor.YELLOW + "[NPC] Miner:" + ChatColor.WHITE + " Here, take " + ChatColor.GOLD + "$" + amount * 4.5);
            ...
            p.sendMessage(ChatColor.YELLOW + "[NPC] Miner:" + ChatColor.WHITE + " Thank you for your business!");
            p.sendMessage(ChatColor.YELLOW + "[NPC] Miner:" + ChatColor.WHITE + " Here, take " + ChatColor.GOLD + "$" + amount * 9);
        } else {
