...
public class GUICosmetics extends GUI {
    ...
    public void setItems() {
        ...
        addShopItem(10, sword, 1, ChatColor.DARK_AQUA + "Sword Rename " + ChatColor.AQUA + "10 Credits", ChatColor.GRAY + "Rename your sword\n" + ChatColor.GREEN + "\n" + "Rank Required");
        ...
        addShopItem(16, new ItemStack(Material.NAME_TAG, 1), 3, ChatColor.DARK_AQUA + "Custom Prefix " + ChatColor.AQUA + "100 Credits", ChatColor.GRAY + "Customize your prefix\n" + ChatColor.GREEN + "\n" + "Rank Required");
        update();
    }
